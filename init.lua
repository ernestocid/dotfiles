...
-- vim-illuminate Remaps
local illuminate = require("illuminate")
-- delete the defaults
pcall(vim.keymap.del, "n", "<A-n>")
pcall(vim.keymap.del, "n", "<A-p>")
-- new keymaps
vim.keymap.set("n", "<C-n>", illuminate.goto_next_reference, { desc = "Next Reference" })
vim.keymap.set("n", "<C-p>", illuminate.goto_prev_reference, { desc = "Prev Reference" })
